...
Setup Azure / Redis / Blob: [`../setup.md`](../setup.md). Título `dd/mm/aaaa` e shownotes: etapa 4 e [`../feed.md`](../feed.md).
...
No áudio das fatias: “Parte N de M”. E-mail acima do teto não entra no digest — vira série própria. O título do item passou a ser a data na etapa 4.
...
- [x] E-mail acima do teto sai do digest e vira série com fala “Parte N de M”
